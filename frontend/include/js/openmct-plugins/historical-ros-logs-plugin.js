 ...
 * @returns function
 */
export function HistoricalRosLogsPlugin() {
    ...
    var provider = {
      ...
      request: function (domainObject, options) {
        ...
        function transformData(rosMessage) {
          ...
          // special case for rosgraph_msgs/Log
          // if (domainObject.ros.type === "rosgraph_msgs/Log") {
          //   newRosMessage.Level = rosMessageLevelMap[newRosMessage.Level];
          // }
