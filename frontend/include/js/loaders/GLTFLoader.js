...
GLTFLoader = (function () {
  ...
  GLTFLoader.prototype = {
    ...
    load: function (url, onLoad, onProgress, onError, gltfOrdering) { // TODO fix
      var scope = this;
    ...
    parse: function (data, path, onLoad, onError, gltfOrdering) {
      var content;
      var extensions = {};
      ...
      // add the gltf ordering here for safe retrieval later on
      json.gltfOrdering = gltfOrdering;
      ...
      if (json.extensionsUsed) {
        // console.error("GLTF extensionsUsed is true");
        ...
        // console.error("GLTF extensionsUsed is false");
      }
  ...
  function GLTFLightsExtension(json) {
    ...
    // ==================================================
    // console.log("GLTFLightsExtension lights", lights);
    // ==================================================
  ...
  GLTFMaterialsCommonExtension.prototype.getMaterialType = function (material) {
    // console.error("GLTFMaterialsCommonExtension.prototype.getMaterialType running on material:", material);
  ...
  function createDefaultMaterial() {
    // console.error("createDefaultMaterial")
  ...
  GLTFParser.prototype.loadMaterial = function (materialIndex) {
    ...
    return Promise.all(pending).then(function () {
      ...
      if (materialType === THREE.ShaderMaterial) {
        ...
        // this value should be decremented on each new gltf
        // that way only the newest 3d content will be shown on top
        // (i.e. lower polygonOffsetFactor = higher rendering priority)
        materialParams.polygonOffsetFactor = json.gltfOrdering;
    ...
    return this.getMultiDependencies(["accessor", "material"]).then(function (
      ...
      return scope.loadGeometries(primitives).then(function (geometries) {
        for (var i = 0, il = primitives.length; i < il; i++) {
          ...
          // console.log("loadMesh", {primitive, material, geometry});
